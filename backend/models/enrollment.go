...
// Relates a user to a course they are enrolled in and contains details regarding that relation
type CourseEnrollment struct {
	ID             string `json:"id"`             // self
	UserID         string `json:"userID"`         // link
	StaticCourseID string `json:"staticCourseID"` // link
